...
#define PUSH1_PORT        P2
#define PUSH1_SEL         P2SEL
#define PUSH1_DIR         P2DIR
#define PUSH1_IEN         IEN2  /* CPU interrupt mask register */
#define PUSH1_IENBIT      BV(1) /* Mask bit for all of Port_2 */
#define PUSH1_ICTL        P2IEN /* Port Interrupt Control register */
...
{                                                                \
  ...
  LED3_DDR |= LED3_BV;                                           \
                                                                 \
  /* PERCFG |= 0x01;    */       /* U0CFG UART0 */                     \
  /* P1SEL |= 0x30;     */       /* 00110000 P1_4 P1_5 Rx Tx */        \
  P2SEL = 0;                                                     \
                                                                 \
  /* configure tristates */                                      \
  /* P0INP |= PUSH2_BV; */                                            \
  DIY_HUE_Light_HalKeyInit();                                         \
}
